...
series_rating_0 = [data.iloc[i]
                   for i in range(len(data)) if data.iloc[i]['rating'] == 0]
series_rating_2 = [data.iloc[i]
                   for i in range(len(data)) if data.iloc[i]['rating'] == 2]
series_rating_3 = [data.iloc[i]
                   for i in range(len(data)) if data.iloc[i]['rating'] == 3]
series_rating_4 = [data.iloc[i]
                   for i in range(len(data)) if data.iloc[i]['rating'] == 4]
series_rating_5 = [data.iloc[i]
                   for i in range(len(data)) if data.iloc[i]['rating'] == 5]
series_rating_6 = [data.iloc[i]
                   for i in range(len(data)) if data.iloc[i]['rating'] == 6]
series_rating_7 = [data.iloc[i]
                   for i in range(len(data)) if data.iloc[i]['rating'] == 7]
series_rating_8 = [data.iloc[i]
                   for i in range(len(data)) if data.iloc[i]['rating'] == 8]
series_rating_9 = [data.iloc[i]
                   for i in range(len(data)) if data.iloc[i]['rating'] == 9]
series_rating_10 = [data.iloc[i]
                    for i in range(len(data)) if data.iloc[i]['rating'] == 10]
...
def create_popular_series(series):
    ...
    frames_part_10.append(
        series[9*int(len(series)/10): 10*int(len(series)/10)])


# create series_rating_0
frames_part_1 = series_rating_0[0: int(len(series_rating_0)/10)]
frames_part_2 = series_rating_0[int(
    len(series_rating_0)/10): 2*int(len(series_rating_0)/10)]
frames_part_3 = series_rating_0[2 *
                                int(len(series_rating_0)/10): 3*int(len(series_rating_0)/10)]
frames_part_4 = series_rating_0[3 *
                                int(len(series_rating_0)/10): 4*int(len(series_rating_0)/10)]
frames_part_5 = series_rating_0[4 *
                                int(len(series_rating_0)/10): 5*int(len(series_rating_0)/10)]
frames_part_6 = series_rating_0[5 *
                                int(len(series_rating_0)/10): 6*int(len(series_rating_0)/10)]
frames_part_7 = series_rating_0[6 *
                                int(len(series_rating_0)/10): 7*int(len(series_rating_0)/10)]
frames_part_8 = series_rating_0[7 *
                                int(len(series_rating_0)/10): 8*int(len(series_rating_0)/10)]
frames_part_9 = series_rating_0[8 *
                                int(len(series_rating_0)/10): 9*int(len(series_rating_0)/10)]
frames_part_10 = series_rating_0[9 *
                                 int(len(series_rating_0)/10): 10*int(len(series_rating_0)/10)]
...
# singles series
frames_part_1.append(
    series_rating_5[10*int(len(series_rating_5)/10):(10*int(len(series_rating_5)/10)+2)])
frames_part_2.append(series_rating_5[(
    10*int(len(series_rating_5)/10)+2):(10*int(len(series_rating_5)/10)+4)])
frames_part_3.append(series_rating_5[(
    10*int(len(series_rating_5)/10)+4): (10*int(len(series_rating_5)/10)+6)])
frames_part_4.append(series_rating_5[(10*int(len(series_rating_5)/10)+6):])

frames_part_4.append(
    series_rating_6[10*int(len(series_rating_6)/10):(10*int(len(series_rating_6)/10)+1)])
frames_part_5.append(series_rating_6[(
    10*int(len(series_rating_6)/10)+1):(10*int(len(series_rating_6)/10)+3)])
frames_part_6.append(series_rating_6[(
    10*int(len(series_rating_6)/10)+3):(10*int(len(series_rating_6)/10)+5)])

frames_part_6.append(series_rating_7[(
    10*int(len(series_rating_7)/10)):(10*int(len(series_rating_7)/10)+1)])
frames_part_7.append(series_rating_7[(
    10*int(len(series_rating_7)/10)+1):(10*int(len(series_rating_7)/10)+3)])
frames_part_8.append(series_rating_7[(
    10*int(len(series_rating_7)/10)+3):(10*int(len(series_rating_7)/10)+5)])

frames_part_8.append(series_rating_8[(
    10*int(len(series_rating_8)/10)):(10*int(len(series_rating_8)/10)+1)])
frames_part_9.append(series_rating_8[(
    10*int(len(series_rating_8)/10)+1):(10*int(len(series_rating_8)/10)+3)])
frames_part_10.append(series_rating_8[(
    10*int(len(series_rating_8)/10)+3):(10*int(len(series_rating_8)/10)+4)])
